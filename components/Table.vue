                ...
                <el-row>
                    <el-col :offset="1" :span="11">
                        <el-card>
                            ...
                            <vue-json-pretty :deep="1" :data="JSON.parse(props.row.payload)"></vue-json-pretty>
                        </el-card>
                    </el-col>
                    <el-col :offset="1" :span="11">
                        <el-card>
                            ...
                            <vue-json-pretty :deep="1" :data="JSON.parse(props.row.metadata)"></vue-json-pretty>
                        </el-card>
                    </el-col>
                </el-row>
            </template>
